...
import { workspacesCreateEnvelope } from "../funcs/workspacesCreateEnvelope.js";
import { workspacesGet } from "../funcs/workspacesGet.js";
import { workspacesList } from "../funcs/workspacesList.js";
import { workspacesListAssignableRoles } from "../funcs/workspacesListAssignableRoles.js";
import { workspacesListEnvelopes } from "../funcs/workspacesListEnvelopes.js";
...
export class Workspaces extends ClientSDK {
  ...
  async listAssignableRoles(
    ...
    return unwrapAsync(workspacesListAssignableRoles(
      this,
      request,
      options,
    ));
  ...
  async listEnvelopes(
    ...
    return unwrapAsync(workspacesListEnvelopes(
      this,
      request,
      options,
    ));
  ...
  async createEnvelope(
    ...
    return unwrapAsync(workspacesCreateEnvelope(
      this,
      request,
      options,
    ));
