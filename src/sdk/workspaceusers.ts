...
import { workspaceUsersList } from "../funcs/workspaceUsersList.js";
import { workspaceUsersRestoreAccess } from "../funcs/workspaceUsersRestoreAccess.js";
import { workspaceUsersRevokeAccess } from "../funcs/workspaceUsersRevokeAccess.js";
...
export class WorkspaceUsers extends ClientSDK {
  ...
  async list(
    ...
    return unwrapAsync(workspaceUsersList(
      this,
      request,
      options,
    ));
  ...
  async add(
    ...
    return unwrapAsync(workspaceUsersAdd(
      this,
      request,
      options,
    ));
  ...
  async update(
    ...
    return unwrapAsync(workspaceUsersUpdate(
      this,
      request,
      options,
    ));
  ...
  async revokeAccess(
    ...
    return unwrapAsync(workspaceUsersRevokeAccess(
      this,
      request,
      options,
    ));
  ...
  async restoreAccess(
    ...
    return unwrapAsync(workspaceUsersRestoreAccess(
      this,
      request,
      options,
    ));
