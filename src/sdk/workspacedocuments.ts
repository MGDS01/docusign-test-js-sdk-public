...
import { workspaceDocumentsGet } from "../funcs/workspaceDocumentsGet.js";
import { workspaceDocumentsGetContents } from "../funcs/workspaceDocumentsGetContents.js";
import { workspaceDocumentsList } from "../funcs/workspaceDocumentsList.js";
...
export class WorkspaceDocuments extends ClientSDK {
  ...
  async list(
    ...
    return unwrapAsync(workspaceDocumentsList(
      this,
      request,
      options,
    ));
  ...
  async get(
    ...
    return unwrapAsync(workspaceDocumentsGet(
      this,
      request,
      options,
    ));
  ...
  async delete(
    ...
    return unwrapAsync(workspaceDocumentsDelete(
      this,
      request,
      options,
    ));
  ...
  async getContents(
    ...
    return unwrapAsync(workspaceDocumentsGetContents(
      this,
      request,
      options,
    ));
