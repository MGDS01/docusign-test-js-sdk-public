...
export interface Env {
  DOCUSIGN_TEST_O_AUTH2?: string | undefined;

  DOCUSIGN_TEST_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodType<Env, z.ZodTypeDef, unknown> = z.object({
  DOCUSIGN_TEST_O_AUTH2: z.string().optional(),

  DOCUSIGN_TEST_DEBUG: z.coerce.boolean().optional(),
});
