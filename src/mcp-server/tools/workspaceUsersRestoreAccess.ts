...
export const tool$workspaceUsersRestoreAccess: ToolDefinition<typeof args> = {
  name: "workspace-users-restore-access",
...
This operation restores the specified user's access to the workspace. The user must have been previously revoked from the workspace. The access is immediately restored.`,
  ...
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await workspaceUsersRestoreAccess(
      client,
      args.request,
